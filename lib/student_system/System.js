'use strict';
const RedirectStudentCommand = require('./command/DisplayStudentInputCommand');
const RedirectStudentReportCommand = require('./command/DisplayStudentReportCommand');
...
const MainMenuCommand = require('./command/ChooseMainMenuCommand')
