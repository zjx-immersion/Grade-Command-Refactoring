...
const RedirectStudentCommand = require('./DisplayStudentInputCommand')
const RedirectStudentReportCommand = require('./DisplayStudentReportCommand')
...
class MainMenuCommand {
    ...
    exec(input) {
        return this.commandMap.find(cmdObj => cmdObj.status == input).cmd.exec(input)
    }
}
